...
public class EarthquakeCityMap extends PApplet {
	...
	*/
	...
	{  
	    ...
	    int grey = color(150,150,150, alpha);
	    int red = color(150,0,0,alpha);
	...
	private void addKey() {
		...
		fill(190);
		rect(30, 60, 150, 200, 7);
		fill(0, 102, 153);
		textAlign(LEFT, CENTER);
		text("Earthquake Key", 45, 80);
		text(THRESHOLD_MODERATE+"+ magnitude", 65, 110);
		text(THRESHOLD_LIGHT+"+ magnitude", 65, 125);
		text("< "+THRESHOLD_LIGHT +" magnitude", 65, 140);
		//draw(processing.core.PGraphics pg,45,130);
		fill(red);
